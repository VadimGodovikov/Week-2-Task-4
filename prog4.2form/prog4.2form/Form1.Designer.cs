namespace prog4._2form
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Перевод из десятичной системы счисления в двоичную";
			// 
			// label2
			// 
			...
			this.label2.Text = "Введите число, которое хотите перевести";
			// 
			// numericUpDown1
			// 
			this.numericUpDown1.Location = new System.Drawing.Point(253, 49);
			...
			this.textBox1.Size = new System.Drawing.Size(266, 46);
